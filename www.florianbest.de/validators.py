...
class IntSanitizer(IntValidator):
    """IntSanitizer makes sure that the value is a int or tries to cast it"""
...
class FloatSanitizer(FloatValidator):
    """FloatSanitizer makes sure that the value is a float and sanitizes it"""
...
class BoolSanitizer(BoolValidator):
    """BoolSanitizer makes sure that the value is a bool or casts it"""
